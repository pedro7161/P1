...
// Diferente técnica de apontamento de ponteiros para os 
// campos dos registos.
//
// Em vez da conjugação "->" pode-se utilizar "(*p)."
// 
// Todavia, a versão "->" é mais popular
//
// Na versão "(*p)." os parênteses são obrigatórios
// Caso contrário o valor seria armazenado no endereço, 
