...
/*
	Este programa faz uma cópia de um ficheiro de texto, linha a linha, 
	para um outro, mas também escrevendo no ficheiro destino o número da 
    linha atual, através da primitiva fprintf que permite a escrita de 
    texto formatado num ficheiro.
	
	O programa para além de aplicar as primitivas fgets e fputs aplica
	também assim fprintf 

	Além disto, aplica também outra técnica de impressão das mensagens 
...
int main(int argc, char *argv[]) 
{
   ...
   /* abertura dos ficheiros para leitura e escrita */
	...
	if (fp2 == NULL)
	{
		printf("\n\nFicheiro copianoticias.txt nao abriu ou não foi criado para escrita");
	...
	// texto formatado, neste caso o número corrente linhaa 	
