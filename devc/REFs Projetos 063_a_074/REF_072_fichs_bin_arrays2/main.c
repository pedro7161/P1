...
/*
  ...
  Em seguida, pede ao utilizador um número entre 1 e 5 
  e mostra o valor que tinha sido introduzido nessa
  ordem.
  
  Além disto, mostra também o 1º e último elemento do
  ficheiro.
*/

// Permite posicionamentos/saltos no ficheiro binário

/*
  Saltos no ficheiro - cláusulas:
         
  SEEK_SET (ou o valor 0) Salto a partir da origem do ficheiro
           
  SEEK_CUR (ou o valor 1) Salto a partir da posição corrente
