...
#include <stdlib.h> // requerido para a função exit() 
  
// Programa Ref_071_fichs_bin_arrays1

// Ficheiros Binários
// Carregamento de um array num ficheiro binário
// Funções fwrite() e fread()

// Este programa armazena num ficheiro binário cinco 
// dados inteiros que foram digitados para um array
// chamado nums1.

// Finalmente, lê os cinco valores a partir do ficheiro,
...
// abertura do ficheiro dados.dat para escrita binária
                       
  if ( (fp  = fopen("dados.dat", "wb")) == NULL)
  {
     printf("\n\nERRO!\nO Ficheiro não foi aberto para escrita.\n");
...
// os argumentos do comando abaixo são os seguintes:
//
// o endereço do 1º elemento do array (mesmo que nums)
// o tamanho de um inteiro
// o número de valores a carregar no ficheiro
...
// abertura do ficheiro dados.dat agora para leitura
  ...
  {
     printf("\n\nERRO!\nO Ficheiro não foi aberto para leitura.\n");
