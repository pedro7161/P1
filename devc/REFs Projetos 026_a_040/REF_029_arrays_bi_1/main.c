...
/*	Matrizes
	...
	Uma matriz é um array (ou vetor) bidimensinal (em forma de tabela 
	ou grelha) no qual cada elemento é acedido através da referência 
	a uma intersecção de uma linha com uma coluna.
	...
	em duas linhas (as linhas 0 e 1) e por três colunas
	(as colunas 0, 1 e 2).
	...
	(a 2ª linha) e coluna 2 (a 3ª coluna).
