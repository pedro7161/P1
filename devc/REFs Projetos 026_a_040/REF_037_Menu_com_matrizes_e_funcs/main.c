...
int main()
{
	...
	printf("\n\nCalculos_Matriz: \n\n");
	printf("\nEscolha um número de 1 a 5, para sair digite uma letra:\n");
	printf("\n\n1 - Soma Matriz");
	printf("\n\n2 - Média Matriz");
	printf("\n\n3 - Máximo Matriz");
	printf("\n\n4 - Mínimo Matriz");
	printf("\n\n5 - Soma Vértices Matriz");
	printf("\n\n");
...
(mat));
		...
		case 5: printf("\nOs vértices são = %4.2f\n\n",calcver

(mat));
			system("pause");
			break;
		default: printf("\n Digitou um número que nao pertence ao menu\n\n");
				 system("pause");
		}
