...
Este programa é o mesmo que o programa funcs1 com 
a diferença de declarar os protótipos das funcs

Revendo o conceito do Protótipo:
...
O protótipo é uma instrução, então, ele é acompanhado de um ponto e 
