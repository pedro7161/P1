...
/* 
   ...
   Nesta versão vamos usar a estrutura if else if
   Esta é a maneira mais adequada para este tipo de programa
   já que nesta estrutura o teste termina logo que seja encontrado
   um caso verdadeiro.
