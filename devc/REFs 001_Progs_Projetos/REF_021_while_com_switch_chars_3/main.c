...
// Programa que conta a frequência discriminada das vogais e 
// também dos restantes carateres, mas no seu todo, a partir de
// carateres digitados até que seja pressionada a tecla ENTER.
