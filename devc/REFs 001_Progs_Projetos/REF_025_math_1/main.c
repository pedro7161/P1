...
/* Utilização da biblioteca math
	...
	A biblioteca math fornece um conjunto de funções para operações matemáticas, 

	tais como trigonométricas, hiperbólicas, logarítmicas, potênciação e de 
	...
	pow(base, exp) 	Potenciação (base, expoente)

	floor( ) 	Valor inteiro mais próximo para baixo

	ceil( ) 	Valor inteiro mais próximo para cima
